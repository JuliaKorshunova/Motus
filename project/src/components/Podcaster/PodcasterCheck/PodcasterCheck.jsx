  ...
  return (
    <>
      {podcasterData.map((pod, index) => (
        <>
          <Header></Header>
          <img className="imgpod" src={podcast}></img>
          <div className="conteiner">
                    ...
                    <div className="pinkblock">
                      <div className="whiteblockpodcaster">
                        <div className="rowforpodcater">
                          <h2 className="thefforpodcasterprofile">
                            {pod.name}
                          </h2>
                          <div className="usernameforpodacterprofile">
                            @ksoakso
                          </div>
                          ...
                          <div className="countofsubsecond">
                            ...
                            <img src={star} />
                            <p>{pod.countofsubscribseswehave} подписчиков</p>
                          </div>
                        </div>

                        <div className="kolonka">
                          <h6 className="thesecforpodcaster">
                            {pod.descriptionn}
                          </h6>

                          <div className="seroeforpodcaster">
                            <div className="a">
                              <img className="im1podcaster" src={link} />{" "}
                            </div>
                            <a className="ssylkapodcaster">{pod.link}</a>{" "}
                          </div>
                          <div className="rowforcheking">
                            <div className="groupforpodcastercheck">
                              {isHovered1 === true ? (
                                ...
                                <div className="bgforbtnpodcaster" id="1">
                                  {" "}
                                  <SecondImgButtonPink
                                    onClick={() => setIsModalOpenSettings(true)}
                                    onMouseEnter={handleMouseEnter1}
                            ...
                            <p className="checkofprofile">
                              Профиль подкастера проходит проверку
                            </p>
                          </div>
                        </div>
            ...
            <Modal
              isOpen={isModalOpenPodcast}
              onClose={() => setIsModalOpenPodcast(false)}
            />
            <ModalNewPost
            ...
            />
            <ModalBePodcaster
              isOpen={isModalOpenBePodcaster}
              onClose={() => setIsModalOpenBePodcaster(false)}
            />
            <ModalSubscribes
              isOpen={isModalOpenSubscribes}
              onClose={() => setIsModalOpenSubsribes(false)}
            />
            <ModalSettings
