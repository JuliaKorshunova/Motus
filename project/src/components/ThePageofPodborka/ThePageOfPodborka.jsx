      ...
      {infReleases.map((r, index) => (
        <div className="releasephotoanddes2">
            ...
            <div className="whitepodborka">
              ...
              <div className="fixx">
                <div className="centerpod">
                  <img
                    className="releasephotopodborka"
                    src={releasephoto}
                    alt="Release"
                  />

                  <div className="textMain3">
                    <div className="textMain2">{r.nameofpodcast}</div>
                      ...
                      <div className="t1">
                        <>
                          ...
                          <div className="topisanie">
                            ...
                            <div>
                              <div className="nazv1111">{r.name}</div>{" "}
                              {/* Имя автора повторно */}
                              <div className="nazv2222">{r.followers}</div>{" "}
          ...
          <div className="tabformobile">
            <TabsSectionForPodborka
              Active1={tab1}
              onChange={(current) => setTab1(current)}
            />
            <div className="r1">
              {tab1 === "release" && (
              ...
              {tab1 === "opodcaste" && (
                <>
                  <div className="flex-container">
                    <div className="text__for__description1"> {r.desc} </div>
          ...
          <div className="group_8794">
            {infReleases.map((r, index) => (
              <div className="frame_8793">
                <div className="textMain">{r.nameofpodcast}</div>
