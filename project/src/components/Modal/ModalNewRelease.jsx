      ...
      <div className="modal-contentrel">
        ...
        <form className="formformodal" onSubmit={handleSubmit}>
          <div className="obedinforinput">
            ...
            <div
              className={`_bk ${focusedState.input2 && errorDes.trim() === "" ? "_pink" : ""} ${isDesNotEmpty && errorDes.trim() === "" ? "_green" : ""} ${errorDes ? "_red" : ""} `}
            >
              <textarea
            ...
            <div className="frame5_1">
              ...
              <div className="text_for_download">Загрузить файл</div>
            </div>
