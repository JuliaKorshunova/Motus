              ...
              {selectedOption === "Прикрепить ссылку на mave" && (
                <>
                  <div className="inbepod">
                    <div
                      className={`_blackforbepod ${errorAge ? "_red" : ""}  ${focusedState.input6 && errorAge.trim() === "" ? "_pink" : ""} ${errorAge.trim() === "" && isTextareaNotEmpty ? "_green" : ""}`}
                    >
                      <input
                        type="text"
                  ...
                  <div className="btnnForBePodcaster">
                    {isButtonDisabled1 === true ? (
                      <div className="pocastdis">
                        <MainButton2 disabled={true}>
                          {" "}
