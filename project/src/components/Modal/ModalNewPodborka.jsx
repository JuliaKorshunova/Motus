        ...
        <form className="formformodal" onSubmit={handleSubmit}>
          <div className="obedinforinput">
            <div className="inputplustext">
              <div
                className={`_blpass1  ${focusedState.input1 && error.trim() === "" ? "_pink" : ""} ${isNazvNotEmpty && error.trim() === "" ? "_green" : ""} ${error ? "_red" : ""}  `}
              >
                <input
                  type="text"
            ...
            <div className="inputplustext">
              <div
                className={`_textareablack ${focusedState.input2 && errorDesc.trim() === "" ? "_pink" : ""} ${isDescNotEmpty && errorDesc.trim() === "" ? "_green" : ""} ${errorDesc ? "_red" : ""} `}
              >
                <textarea
                  type="name"
              ...
              {errorDesc && <div className="text_for_mistake">{errorDesc}</div>}
            </div>
            ...
            <div className="addrel">Сразу добавить выпуски:</div>

            <div className={`_rectangleGreen`}>
              <input type="text" className={`_rectangle16`} required />
            </div>
