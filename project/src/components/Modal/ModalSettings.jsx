        ...
        <form className="formformodal" onSubmit={handleSubmit}>
          <div className="obedinforinput">
            <div className="inputplustext">
              <div
                className={`_rectangle15_1green ${error ? "rectangle-container-error" : ""} ${focusedState.input1 ? "_rectangle15_3pink" : ""}`}
              >
                <input
                  type="email"
            ...
            <div className="inputplustext">
              <div
                className={`_rectangle15_2green ${error ? "rectangle-container-error" : ""} ${focusedState.input2 ? "_rectangle15_3pink" : ""}`}
              >
                <input
                  type="name"
            ...
            <div className="inputplustext">
              <div
                className={`_rectangle15_3green ${error ? "rectangle-container-error" : ""} ${focusedState.input3 ? "_rectangle15_3pink" : ""}`}
              >
                <input
                  type="text"
            ...
            <div className="inputplustext">
              <div
                style={{
                  backgroundColor: focusedState.input4
                    ? "_rectangle15_3pink"
                    : "",
                }}
                className={`_rectangle15_3green ${errorDes ? "rectangle-container-error" : ""}  ${focusedState.input4 ? "_rectangle15_3pink" : ""}`}
              >
            ...
            <div className="frame5_1">
              ...
              <div className="text_for_download">Загрузить фото профиля</div>
            </div>

            <div className="inputplustext">
              <div
                className={`_rectangle15_3green ${error ? "rectangle-container-error" : ""} ${focusedState.input5 ? "_rectangle15_3pink" : ""}`}
              >
                <input
                  type="text"
            ...
            <div className="inputplustext">
              ...
              <div
                className={`  ${errorPassword ? "_red" : "_blacknewpod2"}  ${focusedState.input6 && errorPassword.trim() === "" ? "_pink" : "_blacknewpod2"} ${isPassNotEmpty && errorPassword.trim() === "" ? "_green" : "_blacknewpod2"}`}
              >
                <input
                  type="password"
