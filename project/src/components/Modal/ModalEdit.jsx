...
export default function ModalEdit(
  { isOpen, onClose, namme = "", dess = "", tagss = "", agge = "" },
  props,
) {
      ...
      <div className="modal-contentEdit">
        ...
        <form className="formformodal" onSubmit={handleSubmit}>
          <div className="obedinforinput">
            <div
              className={` _greennewpod  ${errorName ? "_red" : " "}  ${focusedState.input1 && errorName.trim() === "" ? "_pink" : " "} ${isNameNotEmpty && errorName.trim() === "" ? "_green" : "  "}`}
            >
              <input
                type="text"
            ...
            <div
              className={` _greennewpod  ${errorDes ? "_red" : " "}  ${focusedState.input2 && errorDes.trim() === "" ? "_pink" : " "} ${isDesNotEmpty && errorDes.trim() === "" ? "_green" : ""}`}
            >
              <input
                type="text"
                value={des}
            ...
            <div
              className={` _greennewpod  ${errorTags ? "_red" : ""}  ${focusedState.input3 && errorTags.trim() === "" ? "_pink" : ""} ${isTagsNotEmpty && errorTags.trim() === "" ? "_green" : ""}`}
            >
              <input
                type="text"
            ...
            <div
              className={` _greennewpod ${errorAge ? "_red" : ""}  ${focusedState.input4 && errorAge.trim() === "" ? "_pink" : ""} ${isAgeNotEmpty && errorAge.trim() === "" ? "_green" : ""}`}
            >
              <input
                type="text"
