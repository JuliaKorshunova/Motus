...
export default function OnePodcast({
  name,
  descriptionn,
  image1,
  image2,
        ...
        <div className="blackblocksub">
          <div className="whiteblocksub">
            ...
            <img
              src={image2}
              alt="logo"
              className="picturesub1ForPodcast"
              ref={imageRef}
            />
            <div className="containersub">{/* {props.button}    */}</div>
              ...
              <div className="btnnpod">
                {testDeisabled === true ? (
                  <div className="pocastdis">
                    ...
                    <p>
                      {" "}
                      Чтобы стать подкастером необходимо набрать подписчиков
                    </p>
                  </div>
                ) : isHovered === true ? (
                  <NavLink
