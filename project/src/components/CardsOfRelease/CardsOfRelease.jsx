        ...
        <div className="_whiteblock">
          <div className="testt_release">
            <div className="content-wrapper-release">
              <div className="text__for__name_release-1">{title}</div>
              <div className="container8786-1">
                <div className="_text__time-1">{duration}</div>

                <div className="_text__date-1">{date}</div>
                <img className="star" src={star} alt="star" />

                <div className="_text__time-1">Аудио</div>
              ...
              <div className="_number">{number}</div>
