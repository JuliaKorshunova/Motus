...
import classes from './SecondImgButtonBlack.module.css'
import { useState } from 'react'
//className={` ${pressed? classes.pressedmainbtn : classes.defmainbtn} ${isHovered? classes.hovermainbtn: classes.defmainbtn} `} 
export default function SecondImgButtonBlack( {onClick, children, pressed, hover, className, typeofbuttton,disabled, onMouseDown1, isActive, onMouseEnter,onMouseOver,  onMouseOut , onMouseLeave, isImg, ...props }) { //оставшиеся входящие параметры
  ...
  SecondImgButtonBlack.PropsType={
  ...
  SecondImgButtonBlack.defaultProps = {
