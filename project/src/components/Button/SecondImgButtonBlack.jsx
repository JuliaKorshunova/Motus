...
export default function SecondImgButtonBlack({
  onClick,
  children,
  pressed,
  hover,
  ...
  return (
    <>
      ...
      <div className="wrapper">
        ...
        {/* Это будет ваш зеленый прямоугольник */}
        <button
          {...props}
          disable={disabled}
          ...
          onMouseLeave={onMouseLeave}
          type="button"
          className={`${disabled ? classes.defmainbtndisabled : classes.defmainbtn} ${isActive ? classes.defmainbtnactive : classes.defmainbtn} `}
          onClick={onClick}
        >
          {children}
        </button>
