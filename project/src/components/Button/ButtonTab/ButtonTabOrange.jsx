...
import classes from "./ButtonTabOrange.module.css";
import { useState } from "react";

export default function ButtonTabOrange({
  onClick,
  children,
  pressed,
  hover,
  ...
  const classes1 = classNames(className, { typeofbutton });
  ...
  return (
    ...
    >
      ...
      {/* Условно отображаем изображение */}
    </button>
  );
}

ButtonTabOrange.propTypes = {
