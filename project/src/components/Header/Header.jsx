  ...
  return (
    <header className="header1">
      <div className="forhead">
        ...
        <NavLink to="/podcaster" className="libr" activeClassName="active">
          <img className="usr___btn1" src={user} alt="usr___btn" />
        </NavLink>
      </div>
      <nav className="menu">
        <div className="frame4">
          <NavLink to="/main" className="sub" activeClassName="active">
            Главная
          </NavLink>
          <NavLink to="/subscr" className="gl" activeClassName="active" exact>
            Мои подписки
          </NavLink>
          <NavLink to="/library" className="libr" activeClassName="active">
            Библиотека
          </NavLink>
        </div>
        <NavLink to="/podcaster" className="libr" activeClassName="active">
