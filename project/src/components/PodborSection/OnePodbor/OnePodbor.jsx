...
import shuffle24 from "/shuffle.svg";
import shuffle16 from "/shuffle.svg";
import SecondImgButton from "../../Button/SecondImgButton";
import { useNavigate } from "react-router-dom";

export default function OnePodbor({
  name,
  descriptionn,
  view,
  release,
  ...
  function ispressed() {
    return setPressed((prevPressed) => !prevPressed), setIsHovered(false);
  }
        ...
        <div className="blackblock">
          <div className="whiteblock1">
            ...
            <div className="seroe1">
              ...
              <p className="des1">{descriptionn}</p>{" "}
            </div>
              ...
              {testDeisabled ? (
                <div className="slushatdis">
                  ...
                  <p>
                    ...
                    {countofsubcribeswenedd} подписчиков
                  </p>
                </div>
              ) : (
