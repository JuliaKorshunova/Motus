    ...
    <>
      ...
      <div className="releasephotoanddes">
          ...
          <div className="whitepodcast">
            ...
            <div className="fix">
              <div className="centerpodcast">
                <img
                  className="releasephoto"
                  src={releasephoto}
                  alt="Release"
                />
                <div className="textMain3-podcast">
                  <div className="textMain2-podcast">
                    {" "}
                      ...
                      <div className="t1">
                        <>
                          ...
                          <div className="t2">
                            ...
                            <div>
                              <h6 className="nazv1">{r.name}</h6>{" "}
                              {/* Имя автора повторно */}
                              <h6 className="nazv222">{r.followers}</h6>{" "}
        ...
        <div className="tabformobile-podcast">
          <TabsSectionForPodcast
            Active1={tab2}
            onChange={(current) => setTab2(current)}
          />
                ...
                <div className="flex-container-podcast">
                  ...
                  <div className="linepodcast">
                    <div className="topisanie1-podcast">
                      ...
                      <div>
                        <h6 className="nazv1">{infReleases[0].name}</h6>{" "}
                        {/* Имя автора повторно */}
                        <h6 className="nazv222">
                          {infReleases[0].followers}
                        </h6>{" "}
                        {/* Количество подписчиков */}
                      </div>
                    </div>
      ...
      <div className="group__8794">
        {infReleases.map((r, index) => (
          <div className="frame__8793">
            <div className="text__for__rich">{r.nameofpodcast}</div>
            <div className="frame__8786">
              <div className="text__for__description">{r.desc}</div>
            </div>
          </div>
        ))}
