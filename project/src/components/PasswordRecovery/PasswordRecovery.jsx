      ...
      <form onSubmit={handlePasswordSubmit}>
        <div className="_frame_88201">
          <div className="inputplustext1">
            <div
              className={` ${focusedState.input1 && error.trim() === "" ? "_pink1" : "_blacknewpod5"}  ${error ? "_red1" : "_blacknewpod5"}   ${isEmailNotEmpty && error.trim() === "" && focusedState.input1 == false ? "_green1" : "_blacknewpod5"}`}
            >
              <input
                type="email"
