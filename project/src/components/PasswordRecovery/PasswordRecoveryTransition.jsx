  ...
  return (
    <>
      ...
      <div className="centerforreg2">
        <div className="text_for_login-zag">Восстановление пароля</div>
        <form onSubmit={handleSubmit}>
          <div className="_frame_88201">
            ...
            <div className="inputplustext1">
              <div
                className={`  ${errorPassword ? "_red1" : "_blacknewpod3"}  ${focusedState.input2 && errorPassword.trim() === "" ? "_pink1" : "_blacknewpod3"} ${isPassNotEmpty && errorPassword.trim() === "" && focusedState.input2 == false ? "_green1" : "_blacknewpod3"}`}
              >
                <input
                  type="password"
            ...
            <div className="btnnForReg-user1">
              {isButtonDisabled1 === true ? (
                <MainButton disabled={isButtonDisabled1}>
                  Отправить пароль
                </MainButton>
              ) : isHovered ? (
