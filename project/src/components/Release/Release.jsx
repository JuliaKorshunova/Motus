...
export default function Podcaster() {
    ...
    fetch("/datarelgroup.json")
      ...
      .then((data) => {
        ...
        if (
          ...
          console.error(
            "Не удалось загрузить комментарии или комментарии пусты",
          );
          return;
        }
        ...
        sortedData.forEach((comment) => {
          ...
          if (Array.isArray(comment.subComments)) {
            console.log(
              "Подкомментарии перед сортировкой:",
              comment.subComments,
            ); // Лог подкомментариев
            ...
            console.log(
              "Подкомментарии после сортировки:",
              comment.subComments,
            ); // Лог после сортировки
          } else {
            console.error(
              "subComments не является массивом или отсутствует в комментарии:",
              comment,
            );
          }
        });
  ...
  function ispressed() {
    return setPressed((prevPressed) => !prevPressed), setIsHoveredb(false);
  }
  ...
  return (
    <>
      <Header />
      <div className="obedinpl1">
        {dataRelGroup.map((h, index) => (
          <div className="releasephotoanddes1" key={index}>
            <div className={`fix1 ${isSticky ? "fixed1" : ""}`}>
              <div>
                <img
                  className="releasephoto1"
                  src={releasephoto}
                  alt="Release"
                />
              </div>
              ...
              <div className="t1">
                ...
                <div className="t2">
                  ...
                  <div>
                    ...
                    <h6 className="nazv1">
                      {h.countofsubscribseswehave} подписчика
                    </h6>
                  </div>
                </div>
              </div>
        ...
        <div className="niz">
          <div className="player">
            <h5 className="kroshka">
              Мои подписки Семейный бюджет Супер - выпуск!
            </h5>
            <VideoPlayer></VideoPlayer>
          </div>
          {dataRelAbout.map((r, index) => (
            <div key={index} className="obedineniep1">
                ...
                <div className="blackblockp">
                  <div className="whiteblockp">
                    <div className="nazv4">
                        ...
                        {isBlockVisible && (
                          <div className="your-block">
                            <div className="your-block1">
                              {" "}
                              <img className="podn" src={save} />{" "}
                              <p>Сохранить</p>{" "}
                            </div>
                            <div className="your-block1">
                              {" "}
                              <img className="podn" src={error} />{" "}
                              <p>Пожаловаться</p>{" "}
                            </div>
                            <div className="your-block1">
                              {" "}
                              <img className="podn" src={copy} />{" "}
                              <p>Копировать</p>{" "}
                            </div>
                          </div>
                        )}
                      ...
                      <div className="foradaptiv">
                        {dataRelGroup.map((h, index) => (
                          <div className="releasephotoanddes1" key={index}>
                            <div className="rowforbtn">
                              <div className="t1foradaptiv">
                                <h6 className="nazv">{h.name}</h6>
                                <div className="t2">
                                  <img
                                    className="ell"
                                  ...
                                  />
                                  <div>
                                    <h6 className="nazvforv">{h.author}</h6>
                                    <h6 className="nazvsub">
                                      {h.countofsubscribseswehave} подписчика
                                    </h6>
                                  </div>
                                </div>
                              </div>
                              <div className="knforadapriv">
                                {pressed ? (
                                  <div
                                    className={isHoveredb ? "" : "bgg2forstop"}
                                    id="1"
                                  >
                                    <SecondButtonBlack
                                      children="Отменить подписку"
                                  ...
                                  <div
                                    className={isHoveredb2 ? "" : "bgg2forsub"}
                                  >
                                    <SecondButton
                                      onMouseEnter={handleMouseEnterb2}
                                      onClick={ispressed}
                            ...
                            <div className="nazv2forhashtaf">
                              {h.hashtags.map((hashtag, hIndex) => (
                                <h6 className="nazv3forhashtag" key={hIndex}>
                                  {hashtag.name}
                                </h6>
                              ))}
                            </div>
            ...
            <div className="rasst2">
              <div className="comments-count">
                ...
                {readCommData.length === 1 ? (
                  ...
                  <p className="comments-countp">
                    {readCommData.length} комментария
                  </p>
                ) : (
                            ...
                            {activeComments.length > 0 &&
                              activeIndex === index && (
                                <div className="comments-list1">
                                  {readCommData[index].subComments.length >
                                    visibleCount1 &&
                                    checkZafruzki && ( // Проверка, превышает ли количество комментариев видимое количество
                                      <p
                                        className="zagr"
                                        style={{ cursor: "pointer" }}
                                        onClick={loadMoreComments1}
                                      >
                                        Загрузить ещё
                                      </p>
                                    )}
